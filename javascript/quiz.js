...
["Momtong makki ","Indadgående blokering i midtersektion ","(blokering over forreste ben)",10,6,"","","Hand"],
["Momtong an-makki ","Indadgående blokering i midtersektion ","(Blokering over bagerste ben)",10,4,"","","Hand"],
["Eolgul makki ","Blokering i høj sektion","",10,5,"","","Hand"],
["Momtong jireugi ","Slag fra hoften i midtersektion","",10,9,"","","Hand"],
["Eolgul jireugi ","Slag fra hoften i høj sektion","",10,7,"","","Hand"],
["Arae jireugi ","Slag fra hoften i lav sektion","",10,8,"","","Hand"],
...
["Momtong bakat makki ","Udadgående blokering i midtersektion","",9,1,"","","Hand"],
["Bandae jireugi ","Slag fra hoften over forreste ben ","(samme ben/arm)",9,2,"","","Hand"],
["Baro jireugi ","Slag fra hoften over bagerste ben ","(modsat arm/ben)",9,2,"","","Hand"],
["Sonnal eolgul bakat chigi ","Udadgående stød (slag) i høj sektion med enkelt knivhånd"," (håndfladen nedad)",9,1,"","","Hand"],
["Sonnaldeung momtong an chigi ","Indadgående stød/slag i midtersektion hvor der rammes med omvendt knivhånd ","(den side hvor tommelfingeren sidder)",9,0,"","","Hand"],
...
["Anpalmok momtong bakat makki ","Udadgående blokering med inderside af underarm","",8,,"","","Hand"],
["Sonnal makki (momtong og arae) ","Dobbelt knivhåndsblokering"," (midt og lav sektion)",8,,"","","Hand"],
["Sonnal eolgul an chigi ","Indadgående stød (slag) i høj sektion med enkelt knivhånd","",8,,"","","Hand"],
["Hansonnal jebipoom mok chigi ","Enkelthånds svaleteknik"," (stød mod hals med hansonnal (enkeltknivhånd), modsat arm og ben. Kroppen skal drejes så man slår “lidt længere fremme”)",8,,"","","Hand"],
["Hansonnal momtong bakat makki ","Udadgående blokering i midtersektion med enkelt knivhånd","",8,,"","","Hand"],
["Doo bon momtong jireugi ","Dobbeltslag i midtersektion","",8,,"","","Hand"],
["Yeop chagi ","Sidespark","",8,,"","","Ben"],
["Ap-chook dollyo chagi ","Cirkelspark hvor der rammes med fodballen","",8,5,"","","Ben"],
["Pal ","Arm","",8,,"","","Teori"],
...
["Jebipoom mok chigi ","Svaleteknik ","(hansonnal jebipoom mok chigi med hansonnal eolgul makki samtidigt)",7,,"","","Hand"],
["Batangson momtong nulleo makki ","Nedadgående håndrodsblokering"," (“læg låg på”)",7,,"","","Hand"],
["Deung jumeok ap chigi ","Front stød med oversiden af den knyttede hånd ","(ram med knoerne)",7,,"","","Hand"],
["Pyonsonkeut seweon chireugi ","Fingerstik med pyonsonkeut (fingerspidser på linje) i lodret håndstilling (tommelfinger opad)","",7,,"","","Hand"],
["Hansonnal momtong yeop makki ","Blokering i midtersektion med enkelt knivhånd til siden."," (Udføres ofte i Joochoom-seogi)",7,,"","","Hand"],
...
["Me-jumeok momtong naeryo chigi ","Nedadgående slag med ydersiden af knyttet hånd","",6,,"","","Hand"],
["Palkoop dollyo chigi ","Cirkel albueslag","",6,,"","","Hand"],
["Palkoop pyojeok chigi ","Albue pletslag","",6,,"","","Hand"],
["Yeop-jireugi ","Sideslag","",6,,"","","Hand"],
...
["Oh ","Femte (5.)","",6,,"","","Teori"],
["Hansonnal eolgul biteureo makki ","Vrideblokering med enkelt knivhånd","",5,,"","","Hand"],
["Eolgul bakat makki ","Udadgående blokering i høj sektion","",5,,"","","Hand"],
["Batangson momtong makki ","Håndrodsblokering i midtersektion","",5,,"","","Hand"],
...
["Batangson geodureo momtong anmakki ","Håndrodsblokering med støtte (modsat arm og ben) (Støttehånd under anden arm)","",4,,"","","Hand"],
["Eotgeoreo arae makki ","Krydshåndsblokering i lav sektion","",4,,"","","Hand"],
["Gawi makki ","Sakse blokering","",4,,"","","Hand"],
["Doo jumeok jecheo jireugi ","Dobbeltslag med knyttet næve med håndfladen opad","",4,,"","","Hand"],
["Momtong hechyomakki ","Udadgående adskilleblokering","",4,,"","","Hand"],
["Geodeureo deung-jumeok eolgul ap chigi ","Omvendt knoslag i høj sektion med støtte ","(Støttehånd under anden arm)",4,,"","","Hand"],
["Eolgul seweon bakat chigi ","Udadgående slag i høj sektion med lodret håndstilling","",4,,"","","Hand"],
["Batangson momtong anmakki ","Håndrodsblokering"," (modsat arm/ben)",4,,"","","Hand"],
...
["Geodeureo momtong bakat makki ","Blokering i midtersektion med støtte ","(støttehånd ved siden af albuen på den hånd der blokerer)",3,,"","","Hand"],
["Geodeureo arae makki ","Blokering i lav sektion med støtte ","(støttehånd ved siden af albuen på den hånd der blokerer)",3,,"","","Hand"],
["Oe-santeul makki ","En-hånds bjergblokering (halvt bjerg)","",3,,"","","Hand"],
["Dan-gyo teok jireugi ","Træk med én hånd og udfør slag mod hage med den anden","",3,,"","","Hand"],
...
["Hansonnal arae makki ","Enkelt knivhåndsblokering i lav sektion","",2,,"","","Hand"],
["Palkoop naeryo chigi ","Nedadgående albuestød","",2,,"","","Hand"],
["Palkoop olryeo chigi ","Opadgående albuestød","",2,,"","","Hand"],
["Jageun dolcheogi ","Lille hængsel","",2,,"","","Hand"],
...
["Pyojeok-jireugi ","Plet slag","",1,,"","","Hand"],
["Palkoop yeop chigi ","Albuestød til siden","",1,,"","","Hand"],
["Me jumeok arae pyojeok chigi ","Pletslag i lav sektion","",1,,"","","Hand"],
["Mooreup keokki ","“Knække knæ”","",1,,"","","Hand"],
["Anpalmok hechyo makki ","Adskilleblokering med indersiden af underarm","",1,,"","","Hand"],
["Pyeonsonkeut jechyo-chireugi ","Fingerstik med håndfladen opad","",1,,"","","Hand"],
["Kaljebi ","Slag/stik mod hals med agwison"," (Rundingen mellem tommel- og pegefinger)",1,,"","","Hand"],
